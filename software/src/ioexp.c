...
{ // 何も押していない時
    {0x0f, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00}, // L-Shift, L-Ctrl, L-Alt, Space, ↑, ↓, ←, →
    {0x0f, 0x2d, 0x5b, 0x61, 0x73, 0x74, 0x72, 0x34}, // R-Shift, -, [, a, s, t, r, 4
    {0x00, 0x3d, 0x27, 0x7a, 0x64, 0x79, 0x65, 0x35}, // NERD, =, ', z, d, y, e, 5
    ...
    {CODE_2NDFN, 0x00, 0x6d, 0x6e, 0x6b, 0x6c, 0x33, 0x30}  // 2ndFn, Ins, m, n, k, l, 3, 0
},
{ // Shift押した状態
    {0x0f, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00}, // L-Shift, L-Ctrl, L-Alt, Space, ↑, ↓, ←, →
    {0x0f, 0x5f, 0x7b, 0x41, 0x53, 0x54, 0x52, 0x24}, // R-Shift, _, {, A, S, T, R, $
    {0x00, 0x2b, 0x22, 0x5a, 0x44, 0x59, 0x45, 0x25}, // NERD, +, ", Z, D, Y, E, %
    ...
    {CODE_2NDFN, 0x00, 0x4d, 0x4e, 0x4b, 0x4c, 0x23, 0x29}  // 2ndFn, Ins, M, N, K, L, #, )
}
};
// オリジナル文字コード
// 0xfe: Caps
